    ...
    <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-white/40 shadow-sm border-b border-white/20">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-4 sm:px-6">
        ...
        >
          ...
          />
          <h1 className="text-base sm:text-xl font-semibold text-blue-700 whitespace-nowrap">
            EYA Health
          </h1>
        </motion.div>
        ...
        <nav className="hidden md:flex space-x-6 text-sm font-medium text-gray-700 items-center">
          <Link href="#origine" className="hover:text-blue-600 transition">
            ORIGINE
          </Link>
          <Link href="#fonctionnement" className="hover:text-blue-600 transition">
            FONCTIONNEMENT
          </Link>
           <Link href="#OBJECTIFS" className="hover:text-blue-600 transition">
            OBJECTIFS
          </Link>
        </nav>
