...
import { ArrowLeft, UserPlus, Sparkles, CheckCircle, User, Mail, Lock, Shield, Building2, Lightbulb } from "lucide-react";
      ...
      <header className="w-full bg-white/70 backdrop-blur-2xl shadow-xl px-6 py-4 fixed top-0 left-0 right-0 z-50 border-b border-white/20">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between relative z-10">
          ...
          <nav className="hidden md:flex items-center gap-3">
            <Link href="/admin5/utilisateurs" className="group flex items-center gap-2 px-6 py-3 rounded-xl bg-white/80 hover:bg-white text-gray-700 hover:text-gray-900 transition-all duration-300 shadow-md hover:shadow-xl border border-gray-200 hover:border-gray-300 hover:scale-105">
          ...
          <div className="md:hidden relative">
            ...
            {menuOpen && (
              <div className="absolute right-0 mt-3 w-72 bg-white/95 backdrop-blur-xl shadow-2xl rounded-2xl overflow-hidden border border-gray-200 animate-fadeIn">
                <div className="p-3">
                  <Link href="/admin5/utilisateurs" onClick={() => setMenuOpen(false)} className="w-full flex items-center gap-3 px-5 py-3.5 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-700 hover:text-gray-900 transition-all duration-300 hover:shadow-md font-semibold">
                    <ArrowLeft size={18} />
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-lg mb-4">
                  Enregistrez un nouvel utilisateur dans le système en définissant ses informations personnelles, son rôle et son service d'affectation pour une gestion optimale des accès et des responsabilités.
                </p>
                
                {/* Tags informatifs adaptés aux utilisateurs */}
        ...
        <div className="mb-8 bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200 overflow-hidden hover:shadow-3xl transition-all duration-500">
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">Informations de l'Utilisateur</h3>
                <p className="text-sm text-gray-600">Remplissez tous les champs requis pour créer le compte</p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-6 border border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="font-bold text-gray-900 text-lg">
              Conseils pour créer un utilisateur
            </h4>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-blue-100 hover:border-blue-300 transition-colors group">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">Nom complet</h5>
                  <p className="text-sm text-gray-600">Saisissez le nom et prénom complets de l'utilisateur pour faciliter son identification dans le système</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-purple-100 hover:border-purple-300 transition-colors group">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">Adresse email</h5>
                  <p className="text-sm text-gray-600">Utilisez l'email professionnel qui servira d'identifiant de connexion unique pour l'utilisateur</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-indigo-100 hover:border-indigo-300 transition-colors group">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">Mot de passe sécurisé</h5>
                  <p className="text-sm text-gray-600">Créez un mot de passe fort (minimum 8 caractères) que l'utilisateur pourra modifier après sa première connexion</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-green-100 hover:border-green-300 transition-colors group">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">Rôle et permissions</h5>
                  <p className="text-sm text-gray-600">Définissez le niveau d'accès : Administrateur (tous droits) ou Utilisateur (accès limité à son service)</p>
                </div>
              </div>
            </div>

            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-orange-100 hover:border-orange-300 transition-colors group md:col-span-2">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-orange-100 group-hover:bg-orange-200 rounded-lg flex items-center justify-center flex-shrink-0 transition-colors">
                  <Building2 size={16} className="text-orange-600" />
                </div>
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">Service d'affectation</h5>
                  <p className="text-sm text-gray-600">Assignez l'utilisateur au service hospitalier approprié pour qu'il puisse gérer les stocks et demandes spécifiques à son département</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {showSuccess && (
        <div className="fixed top-24 right-6 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-green-200 p-6 z-50 animate-slideIn max-w-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-1">Utilisateur créé avec succès !</h4>
