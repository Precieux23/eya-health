...
import { ArrowLeft, Plus, Sparkles, Package, CheckCircle } from "lucide-react";
...
export default function CreateProductPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      {/* Contenu principal avec design moderne - ESPACE AJOUTÉ */}
            ...
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-lg mb-4">
                  Ajoutez un nouveau produit à votre inventaire en remplissant soigneusement le formulaire ci-dessous.
                </p>
        ...
        <div className="mb-8 bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200 overflow-hidden hover:shadow-3xl transition-all duration-500">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">Informations du Produit</h3>
                <p className="text-sm text-gray-600">Tous les champs marqués d'un * sont obligatoires</p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span>Vérifiez que le <strong>nom du produit</strong> est clair et descriptif</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 font-bold mt-0.5">•</span>
              <span>Assurez-vous que l'<strong>unité</strong> correspond au type de produit</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 font-bold mt-0.5">•</span>
              <span>Sélectionnez la <strong>catégorie appropriée</strong> pour faciliter la recherche</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 font-bold mt-0.5">•</span>
              <span>Faites attention à la <strong>date d'expiration</strong> pour aider à l'identification</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      {showSuccess && (
        <div className="fixed top-24 right-6 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-green-200 p-6 z-50 animate-slideIn max-w-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-1">Produit créé avec succès !</h4>
