...
import { ArrowLeft, Plus, Sparkles, Package, CheckCircle, Building2, Users, ClipboardList, Lightbulb } from "lucide-react";
      ...
      <header className="w-full bg-white/70 backdrop-blur-2xl shadow-xl px-6 py-4 fixed top-0 left-0 right-0 z-50 border-b border-white/20">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between relative z-10">
          ...
          <nav className="hidden md:flex items-center gap-3">
            <Link href="/admin1/services" className="group flex items-center gap-2 px-6 py-3 rounded-xl bg-white/80 hover:bg-white text-gray-700 hover:text-gray-900 transition-all duration-300 shadow-md hover:shadow-xl border border-gray-200 hover:border-gray-300 hover:scale-105">
          ...
          <div className="md:hidden relative">
            ...
            {menuOpen && (
              <div className="absolute right-0 mt-3 w-72 bg-white/95 backdrop-blur-xl shadow-2xl rounded-2xl overflow-hidden border border-gray-200 animate-fadeIn">
                <div className="p-3">
                  <Link href="/admin1/services" onClick={() => setMenuOpen(false)} className="w-full flex items-center gap-3 px-5 py-3.5 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-700 hover:text-gray-900 transition-all duration-300 hover:shadow-md font-semibold">
                    <ArrowLeft size={18} />
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start gap-6">
              <div className="flex-shrink-0">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl relative group hover:scale-110 transition-transform duration-500">
                  ...
                  <Building2 size={32} className="text-white relative z-10" />
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-lg mb-4">
                  Enregistrez un nouveau service hospitalier pour organiser et gérer efficacement les ressources et le personnel.
                </p>
                
                {/* Tags informatifs adaptés aux services */}
        ...
        <div className="mb-8 bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200 overflow-hidden hover:shadow-3xl transition-all duration-500">
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">Informations du Service</h3>
                <p className="text-sm text-gray-600">Renseignez les détails du service à créer</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 relative">
            ...
            <div className="relative z-10">
              <ServiceForm onSuccess={(res) => {
                if (res) {
                  setShowSuccess(true);
                  setTimeout(() => { router.push("/admin1/services"); }, 1500);
                } else { router.back(); }
              }} />
            </div>
          </div>
        ...
        <div className="mb-8 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-6 border border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="font-bold text-gray-900 text-lg">
              Conseils pour créer un service
            </h4>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-blue-100 hover:border-blue-300 transition-colors group">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">Nom du service</h5>
                  <p className="text-sm text-gray-600">Choisissez un nom clair et identifiable (ex: Cardiologie, Urgences, Pédiatrie)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-purple-100 hover:border-purple-300 transition-colors group">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-1">Description détaillée</h5>
                  <p className="text-sm text-gray-600">Précisez les activités principales et les spécialités du service</p>
                </div>
              </div>
            </div>
      ...
      {showSuccess && (
        <div className="fixed top-24 right-6 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-green-200 p-6 z-50 animate-slideIn max-w-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-1">Service créé avec succès !</h4>
