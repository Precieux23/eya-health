...
import { Plus, ArrowLeft, Edit, X, Package, Sparkles, TrendingUp, Activity } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-20 relative z-10">
            ...
            <div className="mt-28 mb-8 bg-white/95 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-2xl max-w-4xl w-full mx-4 relative border border-gray-200 transform animate-scaleIn h-fit">
              ...
              <ServiceForm onSuccess={(newServ) => {
                if (newServ) {
                  ...
                  setTimeout(() => { setSubmitMessage("Redirection..."); handleSuccessCreate(newServ); }, 1000);
            ...
            <div className="mt-28 mb-8 bg-white/95 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-2xl max-w-4xl w-full mx-4 relative border border-gray-200 transform animate-scaleIn h-fit">
              ...
              <ServiceForm initial={editing} onSuccess={(updatedServ) => {
                if (updatedServ) {
                  ...
                  setTimeout(() => { setSubmitMessage("Redirection..."); handleSuccessEdit(updatedServ); }, 1000);
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-gray-600 font-semibold">Services</div>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span>Actifs et opérationnels</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-gray-600 font-semibold">Performance</div>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-gradient-to-r from-emerald-500 to-teal-500 h-2 rounded-full transition-all duration-1000" style={{ width: '94%' }}></div>
                </div>
                <p className="text-xs text-gray-500 mt-2">Excellent rendement</p>
              </div>
            </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, i) => (
                      <div key={i} className="w-1.5 h-4 bg-gradient-to-t from-violet-500 to-purple-400 rounded-full" style={{ height: `${12 + i * 3}px` }}></div>
                    ))}
                  </div>
                  <span>Uptime excellent</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Liste des services - PLEINE LARGEUR */}
          ...
          <div className="bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-gray-200 hover:shadow-3xl transition-all duration-500 w-full">
            <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-8 py-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-white">Liste des services</h2>
            ...
            <div className="p-6">
              {loading ? (
                <div className="flex flex-col items-center justify-center py-16 space-y-4">
                  ...
                  <p className="text-gray-600 font-semibold animate-pulse">Chargement des services...</p>
                </div>
              ) : (
