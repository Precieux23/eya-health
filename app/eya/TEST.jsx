    ...
    <main className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-slate-100">
      ...
      <section id="fonctionnement" className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            {[
              { value: "-30%", label: "Réduction estimée des ruptures", gradient: "from-green-500 to-emerald-600", icon: "📉" },
              { value: "+40%", label: "Efficacité opérationnelle", gradient: "from-blue-500 to-indigo-600", icon: "⚡" },
